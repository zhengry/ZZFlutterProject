...
class ChannelDetail {
  int code;
  String message;
  List<ChannelDetailResult> result;

  ChannelDetail({this.code, this.message, this.result});

  ChannelDetail.fromJson(Map<String, dynamic> json) {
    code = json['code'];
    message = json['message'];
    if (json['result'] != null) {
      result = new List<ChannelDetailResult>();
      json['result'].forEach((v) {
        result.add(new ChannelDetailResult.fromJson(v));
      });
    }
  }
...
class ChannelDetailResult {
  ...
  ChannelDetailResult.fromJson(Map<String, dynamic> json) {
